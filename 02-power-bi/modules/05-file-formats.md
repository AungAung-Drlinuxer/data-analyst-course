# Module 5: Power BI File Formats & Templates

## Power BI File Types

Power BI သည် ဖိုင်အမျိုးအစား ၄ မျိုးကိုအသုံးပြုပါသည်။ ဖိုင်တစ်ခုချင်းစီတွင် ကိုယ်ပိုင်အသုံးပြုပုံနှင့်ရည်ရွယ်ချက်ရှိပါသည်။

### 1. PBIX (Power BI Desktop File)

ဤသည်မှာ Power BI ၏အဓိကဖိုင်အမျိုးအစားဖြစ်ပြီး report, data model, queries, measures, visuals အားလုံးပါဝင်ပါသည်။ PBIX ဖိုင်တစ်ခုတွင် -
- Report definition (pages, visuals, bookmarks)
- Data model (tables, relationships, measures)
- Power Query queries (M code)
- Custom visuals references
- Theme and formatting settings

### 2. PBIT (Power BI Template)

Template ဖိုင်များသည် data မပါပဲ report structure နှင့် measures များကိုသာသိမ်းဆည်းပါသည်။ တူညီသော report ကို clients/teams အများအတွက်ထပ်ခါတလဲလဲသုံးရန်အဆင်ပြေပါသည်။

Template ဆောက်ရန်: File → Export → Power BI Template

### 3. PBIDS (Power BI Data Source)

Data source connection settings များကိုသိမ်းဆည်းသောဖိုင်ဖြစ်ပါသည်။ Server name, database, authentication type များပါဝင်ပါသည်။

### 4. PBIP (Power BI Project - 2023+)

Git-friendly format ဖြစ်ပြီး report ကို JSON/text files များအဖြစ်ခွဲထုတ်သိမ်းဆည်းပါသည်။ Version control (Git) အတွက်အထူးသင့်တော်ပါသည်။

## File Size Comparison

| Format | Contains Data | Contains Code | Use Case |
|--------|--------------|---------------|----------|
| PBIX | Yes | Yes | Standard sharing |
| PBIT | No | Yes | Reusable templates |
| PBIDS | No | Yes | Standardized connections |
| PBIP | Yes (external) | Yes | Git version control |
