# Module 7: Data Visualization & Charts

## Chart အမျိုးအစားများနှင့်အသုံးပြုပုံ

Data visualization ဆိုသည်မှာ data များကို chart, graph, map စသည့် visual formats များဖြင့်ပြသခြင်းဖြစ်ပါသည်။ သင့်တော်သော chart type ကိုရွေးချယ်ခြင်းသည် data story ကိုထိရောက်စွာပြောပြနိုင်ရန်အရေးကြီးပါသည်။

### Comparison Charts

| Chart Type | Best For | Example |
|------------|----------|---------|
| Column/Bar Chart | Category comparison | Sales by Region |
| Stacked Bar Chart | Part-to-whole | Revenue by Product Category |
| Clustered Column | Multiple series comparison | Sales by Year and Region |

### Trend Charts

| Chart Type | Best For | Example |
|------------|----------|---------|
| Line Chart | Time series trends | Monthly Sales |
| Area Chart | Volume over time | Cumulative Revenue |
| Ribbon Chart | Rank changes | Top Products over Months |

### Composition Charts

| Chart Type | Best For | When to Avoid |
|------------|----------|---------------|
| Pie/Donut | Simple proportions (max 5-7 categories) | Many categories |
| Treemap | Hierarchical proportions | Simple datasets |
| Waterfall | Cumulative effect (profit/loss) | Non-sequential data |
| Funnel | Sequential stages (sales pipeline) | Non-sequential data |
