# Module 10: Slicers & User Controls

## Slicer ဆိုတာဘာလဲ?

Slicer သည် user မှကိုယ်တိုင် filter လုပ်နိုင်သော visual တစ်ခုဖြစ်ပါသည်။ ၎င်းသည် report တစ်ခုတွင် interactivity ကိုတိုးမြှင့်ပေးပြီး user များကို data နှင့်တိုက်ရိုက်အပြန်အလှန်ဆက်သွယ်နိုင်စေပါသည်။

### Slicer Types

| Type | Description | Best For |
|------|-------------|----------|
| Dropdown | Dropdown list | Categories များများရှိလျှင် |
| List | Checkbox list | Categories အနည်းငယ် |
| Between | Range slider | Numeric values (Price, Age) |
| Relative Date | Date shortcuts | Quick date filtering |
| Relative Time | Time shortcuts | Time-based reports |
| Hierarchy | Drill-down slicer | Geographical data |
| Advanced | Date range picker | Date range selection |

### Slicer Formatting

Slicer များကို အောက်ပါ settings များဖြင့်ပြင်ဆင်နိုင်ပါသည်-

- **Single Select** — တစ်ခုတည်းသာရွေးခွင့်
- **Multi Select with CTRL** — အများအပြားရွေးခွင့် (default)
- **Select All** — All option ထည့်ရန်
- **Search** — Search bar ထည့်ရန် (categories များများရှိလျှင်)
- **Responsive** — Auto-resize (mobile-friendly)

### Sync Slicers

Slicer တစ်ခုကို page များစွာတွင် ထပ်တူပြုလုပ်နိုင်ပါသည်။
View → Sync Slicers → Pages များကိုရွေးပါ
