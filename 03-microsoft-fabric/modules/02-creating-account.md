...
Microsoft Fabric ကိုအသုံးပြုရန် အောက်ပါအချက်များလိုအပ်ပါသည်-
- Microsoft Account (Work/School account recommended)
- Azure Subscription (optional — Fabric trial ကိုသီးသန့်ရယူနိုင်)
- Modern browser (Edge, Chrome recommended)

### Setup Steps

**Step 1: Fabric Trial**
1. https://app.fabric.microsoft.com ကိုသွားပါ
2. Microsoft Account ဖြင့် sign in လုပ်ပါ
3. Click 'Try Fabric' → 'Start Free Trial'
4. F64 capacity ကို 60 days free ရရှိပါမည်

**Step 2: Azure Subscription (Optional)**
1. portal.azure.com ကိုသွားပါ
2. Create free account ($200 credit for 30 days)
3. Resource group ဆောက်ပါ

### Capacity Management

Fabric capacity ကို Admin Portal မှစီမံနိုင်ပါသည်:
- Pause/resume capacity (cost saving)
- Scale up/down (change SKU)
- Monitor CU usage
...
- Enable/disable Fabric features
- Security policies
