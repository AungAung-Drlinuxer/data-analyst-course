...
SQL Server (On-prem) → Copy Data → Bronze Lakehouse → Spark Notebook → Silver Lakehouse → Dataflow → Gold Lakehouse → Power BI Report (Direct Lake)

### Steps

1. Create SQL Server connection
2. Create pipeline with Copy Activity
3. Transform with PySpark notebook
4. Create Dataflow Gen2 for aggregation
5. Build Power BI report (Direct Lake)
6. Schedule pipeline refresh

## Project 2: Real-Time Analytics

Event Hub → Eventstream → Lakehouse → Real-time Dashboard (Power BI)

## Project 3: Medallion Architecture

Bronze: JSON/CSV raw data ingestion
Silver: Data cleansing with Notebook
Gold: Aggregated views for Power BI

## Best Practices

- Use Git integration for version control
- Implement CI/CD with Deployment Pipelines
- Monitor costs with Fabric Capacity Metrics
- Set up alerts for pipeline failures
- Document architecture and data lineage
