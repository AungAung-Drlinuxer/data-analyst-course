...
### Direct Lake Mode
Data ကို Delta Lake မှတိုက်ရိုက် query လုပ်ပါသည် — no import, no DirectQuery overhead။

### Semantic Model
DAX measures, relationships, hierarchies များပါဝင်သော business logic layer

### Direct Lake Advantages

| Feature | Traditional Import | Direct Lake |
|---------|-------------------|-------------|
| Refresh Speed | Minutes-Hours | 1-2 seconds |
| Data Freshness | Scheduled | Near real-time |
| Memory Usage | High (full import) | Low (metadata only) |

### Auto-create Report

Lakehouse မှ one-click report ဆောက်နိုင်:
Lakehouse → New Power BI Report → Auto-created Visuals

### Composite Models

Direct Lake + Import + DirectQuery ကိုပေါင်းစပ်အသုံးပြုနိုင်:
Direct Lake (Large Fact) + Import (Small Dimensions) + DirectQuery (Real-time Reference)
