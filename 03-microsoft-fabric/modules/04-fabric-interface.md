...
Fabric portal သည် intuitive interface တစ်ခုဖြစ်ပြီး အောက်ပါအဓိကအပိုင်းများပါဝင်ပါသည်-

### Home Page
- Recent items
- Quick actions (New Lakehouse, New Notebook, etc.)
- Learning resources and tutorials
- Workspace shortcuts

### Create Hub
New item များဖန်တီးရန်:
| Item | Purpose | Icon |
|------|---------|------|
| Lakehouse | Data Lake + Tables | 🏠 |
| Dataflow Gen2 | Data Transformation (Power Query) | 🔄 |
| Notebook | Spark/Python Code | 📓 |
| Pipeline | Data Orchestration | 🔗 |
| Semantic Model | Power BI Model | 📊 |
