...
### On-premises Gateway
On-premises SQL Server အတွက် data gateway လိုအပ်ပါသည်။
Gateway သည် on-prem network နှင့် cloud (Fabric) အကြားတံတားတစ်ခုဖြစ်ပါသည်။
- Windows Service အဖြစ် install လုပ်ရန်
- Port 443 (HTTPS) အလုပ်လုပ်ရန်
- Domain/Windows authentication support

### Direct Connect
Azure SQL Database သို့မဟုတ် Azure VM ပေါ်ရှိ SQL Server အတွက်တိုက်ရိုက်ချိတ်ဆက်နိုင်ပါသည်။

### Authentication Methods

| Method | When to Use |
|--------|-------------|
| SQL Auth | Username/Password (simple) |
| Windows Auth | On-prem with domain |
| AAD (Azure AD) | Managed Identity, Service Principal |

### Setup Steps

1. Download and install gateway (on-premises)
2. Register gateway with Power BI/Fabric
3. Add data source connection
4. Test connection
5. Create pipeline with SQL Server source
