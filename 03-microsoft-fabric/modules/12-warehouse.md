...
Warehouse သည် enterprise-grade SQL analytics engine ဖြစ်ပြီး full T-SQL support ရှိပါသည်။

### Warehouse vs Lakehouse

| Feature | Lakehouse | Warehouse |
|---------|-----------|-----------|
| SQL Support | Basic (Read-only) | Full T-SQL |
| Stored Procs | No | Yes |
| Table Constraints | No | Yes (PK, FK) |
| ACID | Delta Lake | Delta + SQL |
| Use Case | Data Engineering | Enterprise Analytics |

### Warehouse Features

- Full T-SQL (DDL, DML, DQL)
...
CREATE TABLE Sales.FactOrders (
    ...
    CustomerID INT REFERENCES Dim.Customer(CustomerID),
    OrderDate DATETIME,
    Amount DECIMAL(18,2)
);
```
