...
## Data Factory ဆိုတာဘာလဲ?

Data Factory သည် data ingestion နှင့် orchestration service ဖြစ်ပါသည်။ ၎င်းသည် data များကို source မှ target သို့ရွေ့ပြောင်းရန်နှင့် transformation လုပ်ရန်အတွက်အသုံးပြုပါသည်။

### Core Concepts

**Pipeline**: Activities များကိုစုစည်းထားသော logical container

**Activities အမျိုးအစားများ**:
- Copy Data — Source → Sink transfer
...
**Triggers**:
- Schedule — Time-based (daily, hourly)
- Tumbling Window — Rolling window (15 min, 1 hour)
- Event — File arrival, blob event

**Connectors**: 200+ built-in connectors for Azure, AWS, GCP, on-premises, SaaS
